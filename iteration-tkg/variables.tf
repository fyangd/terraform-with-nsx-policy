variable "nsx_vars" {
    ...
    default = {
        ...
        vlan_uplink_segment_vlanid = "0"
        tier0_name = "tier0-demo"

        tier0_uplink_edge_node_first_ip="192.168.111.123/24"
        tier0_default_route_next_hop_ip="192.168.111.155"
        ...
        bootstrap = "sudo ip route delete 12.10.10.0/24 ; echo Ponies!23 | sudo -S route add -net 12.10.10.0/24 gw 192.168.111.123" 
    }
}
